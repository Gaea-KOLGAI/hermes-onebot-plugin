...
class ConnectionMixin:
    ...
    async def _connect_reverse_conn(self, conn: _NapCatConnection) -> bool:
        ...
        # Allow binding on 0.0.0.0 for existing local reverse-WS deployments.
        # When no token is configured, each client is still checked in
        # _handle_reverse_ws_client and non-loopback peers are closed with 4001.
